...
proc menueditor_ui {root args} {
	...
	grid rowconfigure $root 6 -weight 1 -minsize 30 -pad 0
	grid columnconfigure $root 1 -weight 1 -minsize 30 -pad 0
	...
	grid columnconfigure $root 7 -weight 0 -minsize 30 -pad 0
